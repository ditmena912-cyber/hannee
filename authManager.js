...
// ID của Role thành viên sau khi đã đăng nhập (Role "may mắn")
...
async function handleAuthInteraction(interaction) {
    ...
    if (customId === 'modal_dangnhap') {
        ...
        // Tự động cấp Role "may mắn" để mở khóa kênh riêng tư cho người chơi
        try {
        ...
        return interaction.reply({ 
            content: `🎉 Đăng nhập thành công vào tài khoản **${user}**! Phòng chơi riêng tư đã được mở khóa cho bạn.`, 
            ephemeral: true 
        });
    }
}
